...
install_xcframework "${PODS_ROOT}/YbridOpus/YbridOpus.xcframework" "YbridOpus" "framework" "ios-arm64_x86_64-maccatalyst" "ios-i386_x86_64-simulator" "ios-arm64_armv7"
